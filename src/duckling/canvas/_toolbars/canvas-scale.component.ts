...
export const ZOOM_LEVELS = [
  0.1, 0.25, 0.33, 0.5, 0.67, 0.75, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4,
  5,
];
...
@Component({
  ...
  template: `
    <dk-toolbar-button icon="minus" tooltip="Zoom out" (click)="onZoomOut()">
    </dk-toolbar-button>
    <span class="scale-label">
      {{ (scale * 100).toFixed(0) + '%' }}
    </span>
    <dk-toolbar-button icon="plus" tooltip="Zoom in" (click)="onZoomIn()">
    </dk-toolbar-button>
  `,
})
