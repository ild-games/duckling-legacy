...
@Component({
  ...
  styleUrls: ['./duckling/layout.css', './edit-collision-types.component.scss'],
  template: `
...
export class EditCollisionTypesComponent {
  ...
  newCollisionTypeIsValid(): boolean {
    return (
      this.newCollisionType !== '' &&
      this.collisionTypes.indexOf(this.newCollisionType) === -1
    );
  }
