 ...
 */
export function drawableAttributeSorter(
  entity1: TaggedEntity,
  entity2: TaggedEntity
) {
  ...
  if (
    drawable1.topDrawable.renderPriority > drawable2.topDrawable.renderPriority
  ) {
    return 1;
  }
  if (
