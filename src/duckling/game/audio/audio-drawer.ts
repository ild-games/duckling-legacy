...
class AudioDrawnConstruct extends DrawnConstruct {
    ...
    constructor(private _musicTexture : Texture,
...
export function getAudioAttributeDrawnConstruct(attribute : Attribute, assetService : AssetService, position : Vector) : DrawnConstruct {
    let musicTexture = assetService.get({key: "fa-music", type: "TexturePNG"}, true);
