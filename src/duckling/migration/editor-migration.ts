...
export let editorMigrations: EditorMigration[] = [
    {
        ...
        function: function(tools: any) {
            return tools.attributeMigration("drawable", function(
                attribute: any
            ) {
                function processDrawable(drawable: any): any {
                    ...
                    if (drawable.__cpp_type === "ild::ContainerDrawable") {
                        ...
                        drawable.__cpp_type === "ild::AnimatedDrawable"
                    ) {
                        let frames: any[] = [];
                ...
                if (attribute.topDrawable) {
                    attribute.topDrawable = processDrawable(
    ...
    },
    {
        ...
        function: function(tools: any) {
            return tools.attributeMigration("collision", function(
                attribute: any
            ) {
                return {
                    ...attribute,
