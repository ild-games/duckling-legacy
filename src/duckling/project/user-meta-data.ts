...
///////////////////
// Scroll Positions
export function setScrollPositionsAction(
    mapName: string,
    newScrollPosition: Vector
...
function _setScrollPositions(
    userMetaData: UserMetaData,
    action: SetScrollPositionsAction
): UserMetaData {
...
////////
// Scale
export function setScaleAction(
    mapName: string,
    newScale: number
): SetScaleAction {
    return {
...
function _setInitialMap(
    userMetaData: UserMetaData,
    action: SetInitialMapAction
): UserMetaData {
    return immutableAssign(userMetaData, {
        ...userMetaData,
...
function _setHiddenLayers(
    userMetaData: UserMetaData,
    action: SetHiddenLayersAction
): UserMetaData {
    let newMapMetaData = { ...userMetaData.mapMetaData };
    newMapMetaData[action.mapName] = {
        ...userMetaData.mapMetaData[action.mapName],
...
export function setHiddenAttributes(
    hiddenAttributes: HiddenAttributes
): SetHiddenAttributesAction {
    return {
...
function _setHiddenAttributes(
    userMetaData: UserMetaData,
    action: SetHiddenAttributesAction
): UserMetaData {
    return immutableAssign(userMetaData, {
        ...userMetaData,
...
//////////
// Reducer
export function userMetaDataReducer(
    state: UserMetaData = { mapMetaData: {} },
    action: Action
) {
    switch (action.type) {
        case ACTION_UPDATE_USER_META_DATA:
            return _updateUserMetaData(
                state,
                action as UpdateUserMetaDataAction
            );
        case ACTION_SET_SCROLL_POSITIONS:
            return _setScrollPositions(
                state,
                action as SetScrollPositionsAction
            );
        ...
        case ACTION_SET_HIDDEN_ATTRIBUTES:
            return _setHiddenAttributes(
                state,
                action as SetHiddenAttributesAction
            );
        default:
            return state;
    }
