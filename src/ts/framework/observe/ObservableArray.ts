import {CustomSerializer, HasCustomSerializer} from '../../util/serialize/CustomSerializer';
import {SerializationContext} from '../../util/serialize/Serializer';
...
export class ObservableArray<T extends Observable<any>> extends Observable<ObservableArrayChanged<T>> implements CustomSerializer {
     ...
     */
    toJSON(context : SerializationContext) {
        return this.data;
    }
     ...
     */
    fromJSON(object, context : SerializationContext) : any {
        var child;
