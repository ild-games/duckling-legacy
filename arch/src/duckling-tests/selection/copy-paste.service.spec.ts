...
describe("CopyPasteService", function() {
    beforeEach(function() {
        ...
        this.assetService = new AssetService(
            this.store,
            new PathService(),
            new RequiredAssetService()
        );
        this.entityBoxService = createEntityBoxService(
            this.assetService,
            this.entityPositionService,
            this.entitySystem
        );
        this.layerService = new EntityLayerService(
            this.entitySytem,
            this.store
        );
        ...
        this.mapParser = new MapParserService(
            this.assets,
            this.requiredAssets,
        ...
        this.availableAttributes = new AvailableAttributeService(
            this.attributeDefault,
            this.project
        );
        this.drawer = new EntityDrawerService(
            this.assets,
            this.renderPriority,
        ...
        this.selection = new SelectionService(
            ...
            this.drawer,
            this.layerService,
            this.entityBoxService,
            this.renderPriority
        );
        this.copyPaste = new CopyPasteService(
            this.store,
            this.entitySystem,
            this.selection,
            this.positionService
    ...
    it("copying an entity updates the store with that entity", function() {
        ...
        expect(this.copyPaste.clipboard.value).to.eql({
            copiedEntities: [{ entity: entity, key: ENTITY_KEY }],
        });
    });
    ...
    describe("pasting an enitity", function() {
        beforeEach(function() {
            ...
            this.movedEntity = immutableAssign(entity, {
        ...
        it("creates a new entity at the specified location", function() {
            this.copyPaste.copy([
                {
                    entity: this.entitySystem.getEntity(ENTITY_KEY),
                    key: ENTITY_KEY,
                },
            ]);
