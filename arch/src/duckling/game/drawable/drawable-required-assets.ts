...
function _drawableRequiredAssets(drawable: Drawable): AssetMap {
    switch (cppTypeToDrawableType(drawable.__cpp_type)) {
        ...
        case DrawableType.Container:
            return _containerDrawableRequiredAssets(
                drawable as ContainerDrawable
            );
        case DrawableType.Animated:
            return _animatedDrawableRequiredAssets(
        ...
        case DrawableType.TileBlock:
            return _tileBlockDrawableRequiredAssets(
...
function _tileBlockDrawableRequiredAssets(
...
function _containerDrawableRequiredAssets(
...
function _animatedDrawableRequiredAssets(
